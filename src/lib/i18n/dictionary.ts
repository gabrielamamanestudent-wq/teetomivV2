...
export const dict = {
  ...
  "op.photo": { en: "Course photo", fr: "Photo du club" },
  "op.updatePhoto": { en: "Update photo", fr: "Changer la photo" },
  "op.uploading": { en: "Uploading…", fr: "Téléversement…" },
  "op.photoHint": {
    en: "JPG, PNG or WebP · up to 4 MB",
    fr: "JPG, PNG ou WebP · jusqu'à 4 Mo",
  },
  "op.photoTooLarge": { en: "Image is too large (max 4 MB).", fr: "Image trop volumineuse (max 4 Mo)." },
  "op.photoFailed": { en: "Upload failed — try again.", fr: "Échec du téléversement — réessayez." },
